        ...
        >
          ...
          <div className="bg-zinc-900/80 border border-zinc-800 rounded-lg p-6">
            ...
            <div className="text-zinc-300 space-y-4">
              ...
              >
                I specialize in creating robust and scalable solutions using Next.js, React, Express, Spring Boot and other cutting-edge technologies.
              </motion.p>
              ...
              >
                My approach to development focuses on writing clean, maintainable code and creating intuitive user experiences. I enjoy tackling complex problems and continuously learning new technologies.
              </motion.p>
            </div>
          </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between text-sm mt-1">
                        ...
                        <span className="text-zinc-400 font-mono mt-1 sm:mt-0">{edu.year}</span>
                      </div>
                    </motion.div>
                  </motion.div>
                ))}
